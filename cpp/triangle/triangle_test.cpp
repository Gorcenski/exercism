...
TEST_CASE("degenerate_triangles_are_cool")
{
    REQUIRE(triangle::flavor::degenerate == triangle::kind(1, 1, 2));
}

TEST_CASE("degenerate_triangles_can_have_a_zero_length_side")
{
    REQUIRE(triangle::flavor::degenerate == triangle::kind(1, 1, 0));
}
